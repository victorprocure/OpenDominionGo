...
func (r *Repo) ListByThreadContext(ctx context.Context, tx repositories.DbTx, threadID int) ([]Row, error) {
	rows, err := tx.QueryContext(ctx, listPostsByThreadSQL, threadID)
	if err != nil {
